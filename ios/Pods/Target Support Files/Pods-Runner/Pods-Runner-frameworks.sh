...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_face_api_beta/flutter_face_api_beta.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FaceSDKBeta/FaceSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/RegulaCommonBeta/RegulaCommon.framework"
fi
